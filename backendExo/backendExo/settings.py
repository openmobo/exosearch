...
SECRET_KEY = 'django-insecure-w(x1nxyk5&g+4p+c$z%2mr556j74r_y2jziewh7dm^4f%ebou('
...
WSGI_APPLICATION = 'backendExo.wsgi.application'
...
CORS_ORIGIN_ALLOW_ALL = True  # not recommended in production
